...
namespace WebApplication2
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        /// 连接字符串
        /// </summary>
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["MySqlConnstr"].ConnectionString;
        ...
        private static MySqlDataReader ExecuteDataReader(string commandText, params MySqlParameter[] parms)
        {
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        private static MySqlDataReader ExecuteDataReader(CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回结果集中的第一个数据表</returns>
        public static DataTable ExecuteDataTable(CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
